...
export type UserMessage = Message<"agent.v1.UserMessage"> & {
  ...
  /**
   * @generated from field: optional bytes selected_context_blob = 10;
   */
  selectedContextBlob?: Uint8Array;

  /**
   * @generated from field: optional string correlation_id = 17;
   */
...
export type ConversationStateStructure = Message<"agent.v1.ConversationStateStructure"> & {
  ...
  /**
   * @generated from field: optional bytes extra_state = 21;
   */
  extraState?: Uint8Array;

  /**
   * @generated from field: optional string client_name = 22;
   */
  clientName?: string;
};
